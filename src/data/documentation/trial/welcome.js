export const welcomeApiDoc = {
  ...
  codeExamples: {
    curl: `
curl --location 'http://localhost:5000/api/v1/welcome' \\
...
$response = Invoke-RestMethod -Uri "http://localhost:5000/api/v1/welcome" -Method Post -Headers $headers
